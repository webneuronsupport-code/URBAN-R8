...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (filterType && filterPrice) {
        const saleOptions = `
            ...
            <option value="low">Hasta $3M MXN</option>
            <option value="mid">$3M - $7M MXN</option>
            <option value="high">Más de $7M MXN</option>
        `;
        
        const rentOptions = `
            <option value="all">Sin límite</option>
            <option value="low">Hasta $15,000 MXN</option>
            <option value="mid">$15,000 - $30,000 MXN</option>
            <option value="high">Más de $30,000 MXN</option>
        `;
